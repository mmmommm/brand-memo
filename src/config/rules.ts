...
export const codeRules = [
  (v: number | string) => !!v || 'code is required',
...
export const capitalizationRules = [
  (v: number | string) => !!v || 'capitalization is required',
]
export const floatRules = [(v: number | string) => !!v || 'float is required']
export const themeRules = [(v: string) => !!v || 'theme is required']
export const priceRules = [(v: number | string) => !!v || 'price is required']
